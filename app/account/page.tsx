  ...
  return (
    <Shell>
      <div className="max-w-6xl mx-auto space-y-8">
        {/* Tajuk Halaman */}
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-primary">Akaun Saya</h1>
          <p className="mt-2 text-muted-foreground">
            Urus profil anda, resepi yang disimpan, serta tetapan keselamatan akaun.
          </p>
        </div>
              ...
              >
                <CardHeader>
                  <div className="flex items-center gap-2">
                    ...
                    <CardTitle className="tracking-tight">{section.title}</CardTitle>
                  </div>
                </CardHeader>
        ...
        <div className="rounded-lg border bg-card text-card-foreground p-6">
          ...
          <p className="text-sm text-muted-foreground">
            Jika anda mempunyai sebarang soalan atau memerlukan bantuan mengenai tetapan akaun anda, 
